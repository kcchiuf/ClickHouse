...
struct Keeper::KeeperHTTPContext : public IHTTPContext
{
    ...
    {
        return context->getConfigRef().getUInt64("keeper_server.http_max_field_name_size", 131072);
    }

    uint64_t getMaxFieldValueSize() const override
    {
        return context->getConfigRef().getUInt64("keeper_server.http_max_field_value_size", 131072);
    }
