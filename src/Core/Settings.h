...
#define COMMON_SETTINGS(M, ALIAS) \
    ...
    M(UInt64, http_max_field_name_size, 131072, "Maximum length of field name in HTTP header", 0) \
    M(UInt64, http_max_field_value_size, 131072, "Maximum length of field value in HTTP header", 0) \
